# Generated by Powerlevel10k configuration wizard on 2024-09-22 at 21:40 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%B%F{$red}%n%f%F{$yellow}@%m%f%b"
  ...
  # Git prompt.
  typeset -g POWERLEVEL9K_VCS_FOREGROUND=023
